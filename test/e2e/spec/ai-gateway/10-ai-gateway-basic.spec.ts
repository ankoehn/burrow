...
// (host-routed) instead of the plan's localhost:9001 (which doesn't bind â€”
...
test("10-ai-gateway-basic: chat-completions SSE works via Burrow â†’ mockoai", async ({ page, request }) => {
